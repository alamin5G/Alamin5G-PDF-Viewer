 ...
 */
package com.alamin5g.pdf.viewer;
...
import com.alamin5g.pdf.viewer.exception.PageRenderingException;
import com.alamin5g.pdf.viewer.link.DefaultLinkHandler;
import com.alamin5g.pdf.viewer.link.LinkHandler;
import com.alamin5g.pdf.viewer.listener.Callbacks;
import com.alamin5g.pdf.viewer.listener.OnDrawListener;
import com.alamin5g.pdf.viewer.listener.OnErrorListener;
import com.alamin5g.pdf.viewer.listener.OnLoadCompleteListener;
import com.alamin5g.pdf.viewer.listener.OnLongPressListener;
import com.alamin5g.pdf.viewer.listener.OnPageChangeListener;
import com.alamin5g.pdf.viewer.listener.OnPageErrorListener;
import com.alamin5g.pdf.viewer.listener.OnPageScrollListener;
import com.alamin5g.pdf.viewer.listener.OnRenderListener;
import com.alamin5g.pdf.viewer.listener.OnTapListener;
import com.alamin5g.pdf.viewer.model.PagePart;
import com.alamin5g.pdf.viewer.scroll.ScrollHandle;
import com.alamin5g.pdf.viewer.source.AssetSource;
import com.alamin5g.pdf.viewer.source.ByteArraySource;
import com.alamin5g.pdf.viewer.source.DocumentSource;
import com.alamin5g.pdf.viewer.source.FileSource;
import com.alamin5g.pdf.viewer.source.InputStreamSource;
import com.alamin5g.pdf.viewer.source.UriSource;
import com.alamin5g.pdf.viewer.util.Constants;
import com.alamin5g.pdf.viewer.util.FitPolicy;
import com.alamin5g.pdf.viewer.util.MathUtils;
import com.alamin5g.pdf.viewer.util.SnapEdge;
import com.alamin5g.pdf.viewer.util.Util;
// 16KB Compatible PDF Rendering
...
public class PDFView extends RelativeLayout {
    ...
    public PDFView(Context context, AttributeSet set) {
        ...
        // Initialize 16KB compatible PDF renderer
        // pdfRenderer will be initialized when PDF is loaded
    ...
    private void load(DocumentSource docSource, String password, int[] userPages) {
        ...
        recycled = false;
        // Start decoding document with 16KB compatible renderer
        decodingAsyncTask = new DecodingAsyncTask(docSource, password, userPages, this, null);
    ...
    /** Returns null if document is not loaded - 16KB Compatible */
    public Object getDocumentMeta() {
        if (pdfFile == null) {
            return null;
        }
    ...
    /** Will be empty until document is loaded - 16KB Compatible */
    ...
    /** Will be empty until document is loaded - 16KB Compatible */
    public List<Object> getLinks(int page) {
        if (pdfFile == null) {
            return Collections.emptyList();
        }
